...
% DOCUMENT LAYOUT
\usepackage{geometry}
\geometry{a4paper, textwidth=5.5in, textheight=9.3in, marginparsep=7pt, marginparwidth=.6in,left=4cm}
...
\section*{Publications \amper~divulgation\hfill{\small\sc {\bfseries bibliometrics}~~~citations 99 · h-index 6 · i-index 5}}
...
\noindent
\years{2013 --- 14}Luis Fonseca, \emph{Towards MVC development in Android with Scala} at {\sc inesc tec}.\\
\years{2013 --- 14}Bruno Maia, \emph{Transformation Patterns for a Reactive application} at {\sc blip}.\\
\years{2013 --- 14}Omar Castro, \emph{Big Data Without Sweating: Leveraging Unix Commands and Visual Programming to Process Large Amounts of Data} at {\sc feup}.\\
...
\noindent \years{2014}Organizer, \emph{``My first 3D film''}, 1\st ed. An introduction to visual programming languages using Alice, ages 12–15 @ Universidade Júnior \\
