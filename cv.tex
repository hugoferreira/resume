...
% DOCUMENT LAYOUT
\usepackage{geometry}
\geometry{a4paper, textwidth=5.5in, textheight=9.4in, marginparsep=7pt, marginparwidth=.6in,left=4cm}
...
\section*{Publications \amper~divulgation\hfill{\href{http://scholar.google.pt/citations?user=bW-JHDEAAAAJ&hl=en}{\small\sc {\bfseries bibliometrics}~~~citations 104 · h-index 6 · i10-index 6}}}
...
\noindent
\years{2014}Luís Fonseca, Tiago Boldt Sousa, Hugo Sereno Ferreira,~\emph{``Rapid Prototyping and Development Framework for Android with Scala''}, Proceedings of the 6\nth Symposium on Informatics. Porto, Portugal.\\
\years{2014}Omar Castro, Hugo Sereno Ferreira, Tiago Boldt Sousa,~\emph{``Collaborative Web Platform for UNIX-based Big Data Processing''}, Proceedings of the 11\nth International Conference on Cooperative Design, Visualization and Engineering. Seattle, USA. Lecture Notes in Computer Science 8683.\\
\years{2014}Nuno Flores, Ademar Aguiar, Hugo Sereno Ferreira,~\emph{``The Concept of Ba Applied to Software Knowledge''}, Proceedings of the 7\nth International Workshop on Cooperative and Human Aspects of Software Engineering.\\
\years{2013}Bruno Ferreira, Vânia Guimarães, Hugo Sereno Ferreira,~\emph{``Smartphone Based Fall Prevention Exercises''}, Proceedings of the 15\nth {\sc ieee} International Conferences on e-Health Networking, Application~\amper~Services {\sc (healthcom 2013)}. Lisbon, Portugal.\\
...
\noindent
\years{\current~2014 ---}Filipe Oliveira, \emph{Exploring Macros for Model-Based Generation of Type-safe REST services in Scala} at {\sc feup}. \\
...
\noindent
\years{\current~2014 ---}João Silva, \emph{Bluetooth based Warning System for Ambient Assisted Living} at Fraunhofer {\sc aicos}.

\subsection*{master degree in informatics engineering co-supervising · feup}
\noindent
\years{2013 --- 14}Pedro Borges, \emph{Online Advertising: Forecasting and Synthesising Web Activity Based On Historical Data} at {\sc shiftforward}.\\
...
\noindent
\years{2012}Diogo Silva, \emph{Desenvolvimento de Aplicação Android para Monitorização de Idosos} at {\sc inesc}.\\
...
\noindent
\years{2014}Organizer, \emph{``My first 3D film''}, 1\st ed. An introduction to visual programming languages using Alice, ages 12–15 @ Universidade Júnior \\
\years{2014}Organizer, \emph{``Mummy, daddy, I shrunk my computer!!!''}. 2\nd ed. An introduction to the RaspberryPI, electronics and programming, ages 12–15 @ Universidade Júnior \\\
\years{2013}Organizer, \emph{``Mummy, daddy, I shrunk my computer!!!''}, 1\st ed. \inurl{http://universidadejunior.up.pt} \\
