...
\geometry{a4paper, textwidth=5.5in, textheight=9.5in, marginparsep=7pt, marginparwidth=.6in,left=4cm}
...
\years{\current~2016 ---}\emph{Collaborating Professor}, {\sc fcup} Faculty of Sciences, University of Porto~\inurl{http://www.fc.up.pt} \\
...
\section*{Publications\hfill{\href{http://scholar.google.pt/citations?user=bW-JHDEAAAAJ&hl=en}{\small\sc h-index 7 · i10-index 6 · citations 135}}}
...
\noindent
\years{\current~2015 ---}Carlos Teixeira, \emph{DevOps: Pratices, Patterns and Tools} at {\sc feup}. \\
\years{\current~2015 ---}Gabriel Candal, \emph{Exploring Visual Programming Concepts for Probabilistic Programming Languages} at {\sc feup}. \\
\years{\current~2015 ---}Pedro Fernandes, \emph{Framework for Monte Carlo Tree Search-related strategies in Competitive Card Based Games} at {\sc feup}. \\
\years{\current~2015 ---}Duarte Duarte, \emph{Framework for Multi-Agent Simulation of User Behavior in E-Commerce Sites} at {\sc shiftforward}. \\
\years{\current~2015 ---}João Pedro Dias, \emph{Reverse Engineering Static Content and Dynamic Behaviour of E-Commerce Sites for Fun and Profit} at {\sc shiftforward}. \\
...
\noindent
\years{\current~2015 ---}André Silva, \emph{Email clustering and classification: A Case Study} at {\sc mailcube}. Supervised by \emph{Prof. Ademar Aguiar}.\\
