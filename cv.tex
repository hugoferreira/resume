...
\geometry{a4paper, textwidth=5.5in, textheight=9.0in, marginparsep=7pt, marginparwidth=.6in,left=4cm}
...
\years{\vspace{-4mm}\\\hspace*{-10mm}\includegraphics[scale=1.2]{qrcode.eps}}\marginimage{\small Professor (8yrs) at {\sc feup}, researcher (9yrs) and entrepreneur (5yrs) with 16+ years of professional experience, 25+ published works (\emph{h-index 7}, \emph{i10-index 6}), and 25+ MSc supervisions, focused in high-quality, adaptable, large-scale, \emph{big-data} software solutions. His career encompasses projects for the portuguese and international military, local government and privately held businesses. Nowadays he focus on Object-Functional Programming, Architecture \amper~Design Patterns, and Machine Learning. First student to be jointly awarded a Ph.D. (with \emph{distinction}) in \emph{Computer Science} by the Universities of Porto {\sc (up)}, Minho {\sc (um)} and Aveiro {\sc (ua)}, he later held a \emph{postdoc} research position at \acr{inesc tec} (1.5yrs) on \emph{Large Scale Software Systems} for \emph{Ambient Assisted Living} and is currently a \emph{Senior Researcher} (7yrs).

\vspace{1mm}After receiving a \emph{LicEng} degree in \emph{Informatics and Computation Engineering}, he performed military \rnd for \acr{nato} at \emph{ParadigmaXis, S.A.} There he progressively assumed the roles of developer, team leader, software architect, and project manager in several government and privately held projects. Early 2011 he co-founded \emph{Shiftforward}, an international strategy and technology consultancy company specialised in \emph{big-data} software solutions for the \emph{Online Advertising} industry.

\vspace{1mm}His university teaching career started shortly after becoming a doctorate candidate in \emph{meta-programming} and \emph{model-driven software engineering} (2007), mainly at the Faculty of Engineering of the University of Porto (\acr{feup}), where he is currently an \emph{Assistant Professor} (8yrs).
...
\years{\current~2009 ---}\emph{Senior Researcher}, Instituto de Engenharia de Sistemas e Computadores, Tecnologia e Ciência
...
\section*{Publications\hfill{\href{http://scholar.google.pt/citations?user=bW-JHDEAAAAJ&hl=en}{\small\sc h-index 7 · i10-index 6 · citations 137}}}
...
\noindent
\publication{2016}{João Silva, Hugo Sereno Ferreira}{Bluetooth Based Warning System for Ambient Assisted Living}{Proceedings da 9ª Edição Encontro Investigação Jovem. Porto, Portugal.}\\
\publication{2015}{Filipe Oliveira, Hugo Sereno Ferreira, Tiago Boldt Sousa}{Exploring the Scala Macro System for Compile Time Model-Based Generation of Statically Type-Safe REST Services}{Proceedings of the 2\nd International Conference on Advances and Trends in Software Engineering. Lisbon, Portugal.}\\
...
\noindent
\years{2015}\emph{Juror, MSc}. Carlos Caldas, \emph{anoBusiness - ferramenta de BPM} @ {\sc fcup}
...
\hspace{-1.9mm}\begin{tabular}{ p{5.7cm} c c c c c c c c c c }
  ...
  & {\footnotesize 07-08} & {\footnotesize 08-09} & {\footnotesize 09-10} & {\footnotesize 10-11} & {\footnotesize 11-12} & {\footnotesize 12-13} & {\footnotesize 13-14} & {\footnotesize 14-15} & {\footnotesize 15-16} \vspace{1mm} & {\footnotesize 16-17} \vspace{1mm}\\
  ...
  \sigla{sope} Operating Systems 					             & · & ·   & \tp & ·    & ·    & ·    & ·    & ·   & \tp & \tp \\
  \sigla{lgp} Project Management Laboratory 		       & · & ·   & ·   & \tpp & ·    & ·    & ·    & \tp & ·   & ·   \\
  ...
  Software Architecture and Design         & ·& ·   & ·    & ·    & ·    & ·    & ·   & ·   & ·   & \ttp \\
\end{tabular}
