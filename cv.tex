...
\vspace{1mm}In 2011 Hugo co-founded \emph{Shiftforward, Lda.} with Paulo Cunha, a strategy and technology consultancy company that specialises in the Online Advertising industry. Its key strengths are the combination of top-brass software architecture, machine learning and big data know-how, with the extended knowledge of the idiosyncrasies of the online media world. With just 2 years of existence, \emph{Shiftforward's} clients are among leading European and North American companies, where we helped them to evaluate, acquire, design and develop the highest-quality technology to fulfil their online media business plans.}
...
\years{\current~2013 ---}João Alves, \emph{Self Managed Monitor and Control Framework} at {\sc inesc tec}.\\
...
\years{2013}\emph{Chair}. Angela Igreja, \emph{AngelMail: an integrated solution for prioritization, visualization and organization of email}, MSc in Informatics Engineering, {\sc feup}\\
\
