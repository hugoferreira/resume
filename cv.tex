...
{\small {\scshape  {\bfseries birth}\hspace{2mm}7/1980 \hspace{7.5mm} {\bfseries e}\hspace{2mm}hugo.sereno@fe.up.pt \hspace{7mm} {\bfseries t}\hspace{2mm}220301567}}\hspace{8mm}{\small\scshape {\bfseries orcid.org/}0000-0002-4963-3525}\\

\years{\vspace{-4mm}\\\hspace*{-10mm}\includegraphics[scale=1.2]{qrcode.eps}}\marginimage{\small Professor (9yrs) at {\sc feup}, researcher (10yrs) and entrepreneur (5yrs) with 16+ years of professional experience, 35+ published works (\emph{h-index 7}, \emph{i10-index 7}), and 30+ degree-awarding (BSc, MSc, PhD) supervisions, focused in high-quality, adaptable, large-scale, \emph{big-data} software solutions. His career encompasses projects for the portuguese and international military, local government and privately held businesses. Nowadays he focus on Object-Functional Programming, Architecture \amper~Design Patterns, and Machine Learning. First student to be jointly awarded a Ph.D. (with \emph{distinction}) in \emph{Computer Science} by the Universities of Porto (\acr{up}), Minho {\sc (um)} and Aveiro {\sc (ua)}, he later held a \emph{postdoc} research position at \acr{inesc tec} (1.5yrs) on \emph{Large Scale Software Systems} for \emph{Ambient Assisted Living}, where he is currently a \emph{Research Associate}.

\vspace{1mm}After receiving a \emph{LicEng} degree in \emph{Informatics and Computation Engineering}, he performed military \rnd for the North Atlantic Treaty Organization (\acr{nato}) at \emph{ParadigmaXis, S.A.} There he progressively assumed the roles of developer, team leader, software architect, and project manager in several government and privately held projects. Early 2011 he co-founded \emph{Shiftforward}, an international strategy and technology consultancy company specialised in \emph{big-data} software solutions for the \emph{Online Advertising} industry, and acted as the Chief Technology Officer (\acr{cto}) until 2016 (5yrs), successfully raising \acr{1m\$} in funding.

\vspace{1mm}His university teaching career started shortly after becoming a doctorate candidate in \emph{meta-programming} and \emph{model-driven software engineering} (2007), mainly at the Faculty of Engineering of the University of Porto (\acr{feup}, since 2008), where he is currently an \emph{Assistant Professor} (9yrs).
...
\noindent
\years{\current~2013 ---}\emph{Assistant Professor}, Faculty of Engineering, University of Porto~\inurl{http://www.fe.up.pt} \\
\years{\current~2017 ---}\emph{Research Associate}, {\sc inesc tec} Instituto de Engenharia de Sistemas e Computadores, Tecnologia e Ciência

\subsection*{past experience in academy}
\noindent
\years{2016}\emph{Collaborating Professor}, {\sc fcup} Faculty of Sciences, University of Porto~\inurl{http://www.fc.up.pt} \\
\years{2009 --- 17}\emph{Senior Researcher}, {\sc inesc tec} Instituto de Engenharia de Sistemas e Computadores, Tecnologia e Ciência \\
...
\noindent
\years{2014 --- 16}\emph{Member of the Board of Directors \amper~Shareholder}, Shiftforward, S.A.~\inurl{http://shiftforward.eu}\\
\years{2011 --- 16}\emph{Co-Founder \amper~Chief Technology Officer} ({\sc cto}), Shiftforward, S.A.~\inurl{http://shiftforward.eu}\\
...
\section*{Publications\hfill{\href{http://scholar.google.pt/citations?user=bW-JHDEAAAAJ&hl=en}{\small\sc h-index 7 · i10-index 7 · citations 165}}}

\subsection*{journal articles~(peer-reviewed)}

\noindent
\publication{2012}{HH Nap, I Bierhoff, A Ferreiro, A Català, A Samà, C Gálvez-Barrón, A Rodríguez-Molinero, HS Ferreira, A Martins, M Antomarini, F Cesaroni, C Sdogati, L Carvalho, R Castro, J Spallek}{Market driven implementation of the eCAALYX solution}{Gerontechnology (12) Volume 2.}\\
\years{2010}Hugo Sereno Ferreira, Ademar Aguiar, João Pascoal Faria,~\emph{``Adaptive Object-Models: A Research Roadmap''}, International Journal On Advances in Software, Vol 3.
...
\awardedpub{2012}{Tiago Boldt Sousa, Hugo Sereno Ferreira}{Object-Functional Patterns: Re-Thinking Development in a Post-Functional World}{Proceedings of the 8\nth International Conference on the Quality of Information and Communications Technology {\sc (sedes-2012)}. Lisbon, Portugal.}\\
\publication{2012}{Sandra Prescher, Alan Bourke, Friedrich Koehler, Angelo Manuel Martins, Hugo Sereno Ferreira, Tiago Boldt Sousa, Rui Castro, António Santos, Marc Torrent Poch, Sergi Gomis Gascó, Hospedales Margarita, John Nelson}{A Ubiquitous Ambient Assisted Living Solution to Promote Safer Independent Living in Older Adults Suffering from Co-morbidity}{Proceedings of the 34\nth Annual International Conference of the {\sc ieee} Engineering in Medicine and Biology Society {\sc (embc-2012)}. California, USA.}\\
...
\noindent\years{\current~2011 ---}Tiago Boldt Sousa, \emph{Engineering Software for the Cloud}. \\
\years{\current~2017 ---}João Pedro Dias, \emph{Towards a Reference Architecture for Orchestrating Large-Scale Internet of Things’ Systems using Visual Programming Languages}. {\color{feup} \emph{To start in September 2017.}}

\subsection*{master degree in informatics engineering supervising · feup}
\noindent
\years{2017 --- }Rui Figueira, \emph{Data ingestion framework using Spark Streaming} at {\sc farfetch}. \\
\years{2017 --- }João Cardoso, \emph{IM2HoT: Interactive Machine-Learning to improve the House of Things} at {\sc feup}.\\
\years{2017 --- }André Humberto Morais, \emph{2HoT4All: Highly-scalable House of Things for All} at {\sc feup}.\\
\years{2016 --- }Maria João Miranda, \emph{Exploring Visual Programming Patterns from the End-User Perspective} at {\sc feup}.\\
\years{2015 --- 16}Carlos Teixeira, \emph{DevOps: Pratices, Patterns and Tools} at {\sc feup}. \\
\years{2015 --- 16}Gabriel Candal, \emph{Exploring Visual Programming Concepts for Probabilistic Programming Languages} at {\sc feup}. \\
\years{2015 --- 16}Pedro Fernandes, \emph{Framework for Monte Carlo Tree Search-related strategies in Competitive Card Based Games} at {\sc feup}. \\
\years{2015 --- 16}Duarte Duarte, \emph{Framework for Multi-Agent Simulation of User Behavior in E-Commerce Sites} at {\sc shiftforward}. \\
\years{2015 --- 16}João Pedro Dias, \emph{Reverse Engineering Static Content and Dynamic Behaviour of E-Commerce Sites for Fun and Profit} at {\sc shiftforward}. \\
...
\years{2015 --- 16}André Silva, \emph{Email clustering and classification: A Case Study} at {\sc mailcube}. Supervised by \emph{Prof. Ademar Aguiar}.\\
...
\years{2014 --- 17}Organizer, \emph{``My first 3D film''}, 1\st, 2\nd, 3\rd and 4\nth editions. An introduction to visual programming languages using Alice, ages 12–15 @ Universidade Júnior \\
...
\noindent
\years{2017}\emph{Chair, MSc}. João Oliveira, \emph{Workflow engine for parallel batch processing}\\
\years{2017}\emph{Chair, MSc}. Pedro Dias Faria, \emph{Test Automation in Continuous Integration for Hardware Validation}\\
\years{2016}\emph{Chair, MSc}. Luís Amaro, \emph{Sistema de Recomendação de Acções de Melhoria Baseado em Crowd-Sourcing e Aprendizagem Automática}\\
\years{2016}\emph{Chair, MSc}. Tiago Coelho, \emph{Automação de Testes de Aplicações Móveis sem Necessidade de Programação}\\
\years{2016}\emph{Chair, MSc}. Vasco Gomes, \emph{Improving Courses Management by Predicting Number of Students}\\
...
\subsection*{other degree-awarding juris}
\noindent
\years{2016}\emph{Main Juror, MSc}. Rúben Barros, \emph{DevOps Technologies for Tomorrow} at {\sc isep}. Supervised by \emph{Prof. Angelo Martins}.\\
\years{2015}\emph{Main Juror, MSc}. Carlos Caldas, \emph{anoBusiness - ferramenta de BPM} @ {\sc fcup}.

\subsection*{grant commitees \amper~scholarship supervisions}
\noindent
\years{2017}Research grant, \emph{NanoSTIMA RL3-2, cf. AE2017-0051}. 12mo @ {\sc inesc tec} \\
\years{2012}Research grant, \emph{Ambient Assisted Living for All}. 18mo @ {\sc inesc tec} \\
...
\noindent
\years{2017}\emph{PC Member}. 8\nth Agile Portugal {(\sc apt 2017)}.\\
\years{2017}\emph{Reviewer}. 22\nd European Conference on Pattern Languages of Programs {(\sc europlop 2017)}\\
\years{2016}\emph{Reviewer}. \emph{``Pervasive and Mobile Computing Journal''}, Elsevier ({\sc issn 1574-1192}).\\
...
\subsection*{other juris}
\noindent
\years{2017} \emph{Juri} at the Spark Agency's ``Pitch Bootcamp FEUP 2017'', {\sc feup}, Porto, Portugal. \\
\years{2016} \emph{Project Reviewer} for the Portugal Ventures' ``Call on Entrepreneurship''.

\subsection*{conference organization}
\noindent
\noindent\years{2017}\emph{Scientific Committee}. Inter-University Programming Marathon ({\sc miup} 2017), Braga@{\sc um}, Portugal.\\
\years{2016}\emph{Scientific Committee}. Inter-University Programming Marathon ({\sc miup} 2016), Lisboa@{\sc fct/unl}, Portugal.\\
\years{2015}\emph{Scientific Committee}. Inter-University Programming Marathon ({\sc miup} 2015), Porto@{\sc fcup}, Portugal.\\
\years{2014}\emph{Chair}. Inter-University Programming Marathon ({\sc miup} 2014), Porto@{\sc feup}, Portugal.\\
\years{2010 --- 12}\emph{Co-Chair}. 1\st, 2\nd and 3\rd Agile Portugal.\\
...
\years{2015 --- 16} \emph{Advisor} for the ``Founders Founders'' co-working space. \\
...
\years{2010} \emph{Juror}. {\sc best} -- Days on Technology 2010 at {\sc feup}.
...
\noindent
\years{2012 --- 16}{\sc ad-forecaster, shiftforward} \emph{cf.} {\sc sifide 0694/2013-e}~\inurl{http://www.adforecaster.com}\\
...
\noindent
\years{2014 --- 16}{\sc ad-stax, shiftforward}~\inurl{http://www.adstax.com}\\
...
\newcommand{\sigla}[1]{\years{\hspace{-1cm}\sc #1}}

\newcolumntype{C}[1]{>{\centering\hspace{0pt}}m{#1}}
\hspace{-1.9mm}\begin{tabular}{ p{5.7cm} c c c c c c c c c c }
  & \multicolumn{6}{c}{\sc\footnotesize assistant lecturer} & \multicolumn{4}{c}{\sc\footnotesize assistant professor} \\
  \cmidrule(lr){2-7} \cmidrule(lr){8-11}
  & {\footnotesize 07-08} & {\footnotesize 08-09} & {\footnotesize 09-10} & {\footnotesize 10-11} & {\footnotesize 11-12} & {\footnotesize 12-13} & {\footnotesize 13-14} & {\footnotesize 14-15} & {\footnotesize 15-16} & {\footnotesize 16-17} \vspace{1mm}\\
  \multicolumn{7}{l}{\color{feup}\sc integrated master in informatics and computing engineering · feup · 5 years\vspace{0.2cm}} \\
  \sigla{mads} Agile Software Development Methodologies & · & ·   & ·   & ·    & \tp  & \tp  & \tp  & ·   & ·   & ·   \\
	\sigla{diss} Dissertation														  & · & ·   & ·   & \tp  & \tp  & \tp  & \tp  & \tp & \tp & \tp \\
  \sigla{sdis} Distributed Systems              		    & · & ·   & ·   & ·    & ·    & ·    & ·    & ·   & \tp & \tp \\
  \sigla{mfes} Formal Methods in Software Engineering   & · & \tp & \tp & \tp  & ·    & ·    & ·    & \tp & \tp & \tp \\
	\sigla{lpoo} Object-Oriented Programming Laboratory   & · & ·   & ·   & \tp  & ·    & ·    & \tp  & ·   & \tp & \tp \\
  \sigla{sope} Operating Systems 					              & · & ·   & \tp & ·    & ·    & ·    & ·    & ·   & \tp & · \\
  \sigla{lgpr} Project Management Laboratory 		        & · & ·   & ·   & \tpp & ·    & ·    & ·    & \tp & ·   & \tp \\
  \sigla{asso} Software Architecture								    & · & ·   & ·   & ·    & ·    & ·    & ·    & ·   & ·   & \tp \\
	\sigla{esof} Software Engineering 					          & · & \tp & ·   & ·    & ·    & \tp  & \tp  & \tp & \tp & \tp \\
	\sigla{ldso} Software Engineering Laboratory 		      & · & \tp & ·   & ·    & ·    & ·    & ·    & ·   & \tp & ·   \\
	\sigla{sesi} Software Engineering Seminars 		        & · & ·   & ·   & ·    & \tp  & ·    & ·    & ·   & ·   & ·   \\
	\\
  ...
  Database Management Systems              & \ttp & ·& ·   & ·    & ·    & ·    & ·    & ·   & ·   & ·   \\
	\\
  \multicolumn{7}{l}{\color{feup}\sc master in software engineering · feup · 2 years\vspace{0.2cm}}\\
  \sigla{ads} Software Architecture and Design         & ·& ·   & ·    & ·    & ·    & ·    & ·   & ·   & ·   & \ttp \\
\end{tabular}
