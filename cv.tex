...
\section*{Publications\hfill{\href{http://scholar.google.pt/citations?user=bW-JHDEAAAAJ&hl=en}{\small\sc h-index 7 · i10-index 7 · citations 156}}}
...
%\years{2016 --- }Henrique Ferrolho, \emph{} at {\sc feup}.\\
...
\years{2014 --- 16}Organizer, \emph{``My first 3D film''}, 1\st, 2\nd and 3\rd editions. An introduction to visual programming languages using Alice, ages 12–15 @ Universidade Júnior \\
...
\noindent\years{2016}\emph{Scientific Committee}. Inter-University Programming Marathon ({\sc miup} 2016), Lisboa@{\sc fct/unl}, Portugal.\\
