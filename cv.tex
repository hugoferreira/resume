...
% DOCUMENT LAYOUT
\usepackage{geometry}
\geometry{a4paper, textwidth=5.5in, textheight=9.8in, marginparsep=7pt, marginparwidth=.6in,left=4cm}
...
\subsection*{others}
\noindent\years{2012}Filipe Correia, Nuno Flores, Hugo Sereno Ferreira, Ademar Aguiar,~\emph{``Assessing Tools for Software Development: An overview of three user evaluations''}, User evaluation for Software Engineering Researchers ({\sc user}) Workshop at the 34\nth International Conference on Software Engineering.\\
...
\years{\current~2013 --- 14} Object-Oriented Programming Laboratory · \emph{2nd yr, {\sc tp}}\\
\years{\current~2012 --- 14} Software Engineering · \emph{3rd yr, {\sc tp}}\\
\years{\current~2011 --- 14} Agile Software Development Methodologies · \emph{5th yr, {\sc tp}} \\
\years{2011 --- 12} Information Systems and Software Engineering Seminars · \emph{5th yr, {\sc t}}\\
\years{2010 --- 11} Object-Oriented Programming Laboratory · \emph{2nd yr, {\sc tp}}\\
\years{2010 --- 11} Project Management Laboratory · \emph{4th yr, {\sc p}}\\
\years{2009 --- 10} Operating Systems · \emph{3rd yr, {\sc tp}}\\
\years{2008 --- 11} Formal Methods in Software Engineering · \emph{4th yr, {\sc tp}}\\
\years{2008 --- 09} Software Engineering · \emph{3rd yr, {\sc tp}}\\
\years{2008 --- 09} Software Engineering Laboratory · \emph{4th yr, {\sc tp}}\\

\noindent{\sc master in electrical and computers engineering · feup · 5 years} \\
\years{\current~2013 --- 14} Operating Systems · \emph{4th yr, {\sc tp}} \\
\years{\current~2011 --- 14} Programming II · \emph{1st yr, {\sc t\amper tp}} \\
\years{2008 --- 11} Formal Methods in Software Engineering · \emph{4th yr, {\sc tp}} \\

\noindent{\sc post-graduation in enterprise application engineering · isep · 1 year}\\
\years{2010 --- 11}Agile Methodologies in Software Engineering · \emph{1st yr, {\sc t\amper tp}} \\

\noindent{\sc licenciate in information science · feup \amper~flup · 3 years}\\
\years{\current~2011 --- 14} Information Systems Analysis II · \emph{3rd yr, {\sc p}} \\

\noindent{\sc licenciate in informatics engineering · istec · 3 years}\\
\years{2007 --- 08}Database Management Systems· \emph{2nd yr, {\sc t\amper tp}}
...
\noindent
\years{\current~2013 ---}João Alves, \emph{---} at {\sc inesc tec}.\\
\years{\current~2012 ---}Luis Simões, \emph{Pattern Language for Managing Open Source Projects}.\\
\years{2012 --- 13}João Figueiredo, \emph{Modularization of Large Web Applications} at Blip.\\
\years{2012 --- 13}Carlos Tiago Babo, \emph{Generic and parameterizable service for remote configuration of mobile phones using Near Field Communication} at Fraunhofer {\sc aicos}.\\
\years{2012 --- 13}Bruno Ferreira, \emph{Smartphone Based Fall Prevention Exercises} at Fraunhofer {\sc aicos}.\\
\years{2012 --- 13}Vasco Grilo, \emph{Towards a Live Development Environment}.\\
\years{2011 --- 12}Tiago Almeida, \emph{End-User Programming In Mobile Devices through Reusuable Visual Components Composition}.\\
\years{2011 --- 12}Jorge Mateus, \emph{Agile Business Intelligence Using Microsoft\reg~SharePoint} at Critical Manufacturing.\\
\years{2011 --- 12}Inês Carvalho, \emph{Espresso Medical Systems} at Scionis - Medical Information Systems.\\
\years{2010 --- 11}André Carmo, \emph{Introducing End-User Reconfiguration on Clinical Knowledge Information Systems} at Critical Software, S.A.\\
\years{2010 --- 11}Marcelo Cerqueira, \emph{Ambiente de Modelação e Configuração de Processos} at Siemens S.A.

\subsection*{master degree in informatics engineering co-supervising (feup)}
\noindent\years{2009 --- 10}João Gradim Pereira, \emph{Improving Variability of Applications using Adaptive Object-Models} at Tecla Colorida, Lda.
...
\subsection*{other educational services}
\noindent\years{\current~2013}\emph{``Pai, Mãe, Encolhi o meu computador!!!''}. Universidade Júnior.

%\hrule
\section*{Scientific services}

\subsection*{degree-awarding juris~~(excluding supervising juris)}
\years{\current~2013}\emph{Juri Member}. Fernando Sérgio Barbosa, \emph{Generic Roles: Reducing Code Replication}, PhD in Informatics Engineering, {\sc feup}\\
...
\years{2011 --- 12} Co-author and commission member for the {\sc eur-ace} accreditation of the {\sc mieic} course at {\sc feup}.
