...
\years{\current~2008 ---}\emph{Visiting Professor}, {\sc feup} Faculty of Engineering, University of Porto~\inurl{http://www.fe.up.pt} \\
\years{\current~2011 ---}\emph{Collaborating Professor}, {\sc flup} Faculty of Arts, University of Porto~\inurl{http://www.letras.up.pt} \\
...
\noindent
\years{2011-2012}\emph{Postdoctoral Researcher}, {\sc inesc} Instituto de Engenharia de Sistemas e Computadores do Porto\\
...
\years{2010-2011}\emph{Independent Consultant} working with Critical Software {\sc pt}, Semasio {\sc de}, SAGE {\sc pt}, Tectonic {\sc uk}, etc.\\
\years{2007-2010}\emph{Researcher}, ParadigmaXis - Arquitectura e Engenharia de Software, S.A.\\
\years{2003-2007}\emph{Software Engineer}, ParadigmaXis - Arquitectura e Engenharia de Software, S.A.\\
\years{2001-2003}\emph{Freelancer} in developing software solutions for medical healthcare and sports centers

\section*{Education}

\noindent\years{2007-2011}\textsc{Ph.D.} in Computer Science (w/ distinction), {\sc mapi} Joint Doctoral Programme, {\sc feup\amper fcup} {\sc um} {\sc ua}\\
...
\noindent\years{2011-2012}Postdoctoral research grant by {\sc inesc}, \emph{cf.} {\sc bpd/110054/caalyx-mv\_usig}\\
\years{2007-2011}Scholarship grant for doctoral studies by {\sc fct}, \emph{cf.} {\sc sfrh/bde/33298/2008} \\
...
\years{2004-2011}{\sc nato}-secret security clearance for military \rnd
...
\subsection*{others}
\noindent\years{2012}Filipe Figueiredo Correia, Nuno Flores, Hugo Sereno Ferreira, Ademar Aguiar,~\emph{``Assessing Tools for Software Development: An overview of three user evaluations''}, User evaluation for Software Engineering Researchers ({\sc user}) Workshop at the 34\nth International Conference on Software Engineering.\\
...
\years{2012}Episode \emph{``What's a Programming Language?''} in \emph{Engenharia num Minuto}~\inurl{paginas.fe.up.pt/~engmin}\\
...
\noindent{\sc master in informatics and computing engineering · feup · 5 years}\\
\years{2012-2013} Software Engineering · \emph{3rd yr, {\sc tp}}\\
\years{2011-2013} Agile Software Development Methodologies · \emph{5th yr, {\sc tp}} \\
\years{2011-2012} Information Systems and Software Engineering Seminars · \emph{5th yr, {\sc t}}\\
\years{2010-2011} Object-Oriented Programming Laboratory · \emph{2nd yr, {\sc tp}}\\
\years{2010-2011} Project Management Laboratory · \emph{4th yr, {\sc p}}\\
\years{2009-2010} Operating Systems · \emph{3rd yr, {\sc tp}}\\
\years{2008-2011} Formal Methods in Software Engineering · \emph{4th yr, {\sc tp}}\\
\years{2008-2009} Software Engineering · \emph{3rd yr, {\sc tp}}\\
\years{2008-2009} Software Engineering Laboratory · \emph{4th yr, {\sc tp}}\\

\noindent{\sc master in electrical and computers engineering · feup · 5 years} \\
\years{\current~2011-2013} Programming II · \emph{1st yr, {\sc t\amper tp}} \\
\years{2008-2011} Formal Methods in Software Engineering · \emph{4th yr, {\sc tp}} \\

\noindent{\sc post-graduation in enterprise application engineering · isep · 1 year}\\
\years{2010-2011}Agile Methodologies in Software Engineering · \emph{1st yr, {\sc t\amper tp}} \\

\noindent{\sc licenciate in information science · feup \amper~flup · 3 years}\\
\years{2011-2013} Information Systems Analysis II · \emph{3rd yr, {\sc tp}} \\

\noindent{\sc licenciate in informatics engineering · istec · 3 years}\\
\years{2007-2008}Database Management Systems· \emph{2nd yr, {\sc t\amper tp}}

\section*{\years{2009 ---}Supervising}

\subsection*{phd in informatics engineering co-supervising (prodei, feup)}
...
\noindent
\years{\current~2012 ---}João Alves, \emph{---} at {\sc inesc tec}.\\
\years{\current~2012 ---}Luis Simões, \emph{Pattern Language for Managing Open Source Projects}.\\
\years{\current~2012 ---}João Figueiredo, \emph{Modularization of Large Web Applications} at Blip.\\
\years{\current~2012 ---}Carlos Tiago Babo, \emph{Generic and parameterizable service for remote configuration of mobile phones using Near Field Communication} at Fraunhofer {\sc aicos}.\\
\years{\current~2012 ---}Bruno Ferreira, \emph{Smartphone Based Fall Prevention Exercises} at Fraunhofer {\sc aicos}.\\
\years{2012-2013}Vasco Grilo, \emph{Towards a Live Development Environment}.\\
\years{2011-2012}Tiago Almeida, \emph{End-User Programming In Mobile Devices through Reusuable Visual Components Composition}.\\
\years{2011-2012}Jorge Mateus, \emph{Agile Business Intelligence Using Microsoft\reg~SharePoint} at Critical Manufacturing.\\
\years{2011-2012}Inês Carvalho, \emph{Espresso Medical Systems} at Scionis - Medical Information Systems.\\
\years{2010-2011}André Carmo, \emph{Introducing End-User Reconfiguration on Clinical Knowledge Information Systems} at Critical Software, S.A.\\
\years{2010-2011}Marcelo Cerqueira, \emph{Ambiente de Modelação e Configuração de Processos} at Siemens S.A.

\subsection*{master degree in informatics engineering co-supervising (feup)}
\noindent\years{2009-2010}João Gradim Pereira, \emph{Improving Variability of Applications using Adaptive Object-Models} at Tecla Colorida, Lda.

\subsection*{bachelor degree in informatics engineering co-supervising (isep)}
\noindent\years{2012}Diogo Ferreira da Silva, \emph{Desenvolvimento de Aplicação Android para Monitorização de Idosos} at {\sc inesc}.\\
\years{2012}Vítor Hugo Moreira, \emph{Desenvolvimento de Aplicação Android para Monitorização de Idosos} at {\sc inesc}.

\subsection*{scientific initiation supervising}
\noindent\years{2012-2013}Luís Fonseca, \emph{Object-Functional Pattern Variants of Adaptive Object-Models} at {\sc inesc tec}.

%\hrule
\section*{Scientific services}

\subsection*{master degree committees~~(excluding supervising juris)}
\years{2011}\emph{Chair}. Tiago Carvalho, \emph{A Meta-Language and Framework for Aspect-Oriented Programming}, MSc in Informatics Engineering, {\sc feup}\\
\years{2011}\emph{Chair}. João Antunes, \emph{Desenvolvimento e integração de editores gráficos de elevado impacto visual}, MSc in Informatics Engineering, {\sc feup}
...
\years{2013}\emph{Book Reviewer}. Alvin Alexander, \emph{``Scala Cookbook''}, O'Reilly Media, Inc., 2013\\
...
\noindent\years{\current~2011 ---}\emph{Head of Laboratory}. Masters in Informatics and Computation Engineering Student's Lab {\sc feup}.\\
\years{2012} Co-author and commission member for the {\sc a3es} accreditation of the {\sc mieic} course at {\sc feup}. \\
\years{2011-2012} Co-author and commission member for the {\sc eur-ace} accreditation of the {\sc mieic} course at {\sc feup}.

\section*{Main Projects}

\subsection*{Research Projects}
\noindent
\years{2011-2014}{\sc aal4all: ambient assisted living for all, inesc porto}, €8.18m \emph{cf.} {\sc qren 13852} \\
...
\years{2011-2013}{\sc caalyx-mv: complete aal market validation, inesc porto}, €3.91m \emph{cf.} {\sc ict-psp-2009-3-250577}\\
...
\years{2011-2012}{\sc ecaalyx: enhanced aal, inesc porto}, €2.7m \emph{cf.} {\sc aal-010000-2009-13}\\
...
\noindent
\years{2004-2005}{\sc mrs: mip reference system, nc3a} \\
...
\years{2003-2004}{\sc mipx: framework for development of command and control systems, nc3a} \\
Architecture, design and implementation of an infrastructure to develop {\sc lc2idem}-based Command and Control Systems.

\subsection*{Industrial Projects}
\noindent
\years{\current~2012 ---}{\sc ad-stress, shiftforward}~\inurl{http://www.adstress.com}\\
...
\years{\current~2012 ---}{\sc ad-forecaster, shiftforward}~\inurl{http://www.adforecaster.com}\\
...
\years{2011-2011}{\sc coolbiz: trading system, banco carregosa} \\
...
\years{2009-2010}{\sc smqvu: urban life quality, cmp} \\
...
\years{2007-2010}{\sc oghma, paradigmaxis} \\
...
\years{2007-2010}{\sc locvs: architectural and archaeological heritage, cmp} \\
...
\years{2006-2007}{\sc geoxis: geo-spatial back-end framework and infrastructure, paradigmaxis} \\
...
\years{2005-2006}{\sc mapadventure, paradigmaxis}~\inurl{http://www.mapadventure.com.pt}\\
...
%\vfill{}
%\begin{center}
%{\scriptsize Last updated in \today}
%\end{center}
